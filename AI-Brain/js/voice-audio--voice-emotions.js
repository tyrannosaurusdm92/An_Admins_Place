...
/* Universal Voice Studio - Emotion overlays for clean expressive speech preview/export */
(() => {
  'use strict';
  ...
  window.UniversalVoiceEmotions = { EMOTIONS, emotionList, emotionByKey, applyEmotion, shapeText, describeEmotion, scaleAdjustment, applyAdjustment };
})();
