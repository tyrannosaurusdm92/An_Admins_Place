...
/* Universal Voice Studio - formant/vocal-tract size and nasal resonance modeling */
(() => {
  'use strict';
  ...
  window.UniversalFormantMath = { BASE_FORMANTS, formantScaleFromProfile, chooseVowelSet, buildFormants, buildNasality, scaleFormants };
})();
