...
/* Universal Voice Studio - audible fantasy accent renderer
...
(() => {
  ...
  const applyTextColor = (text='', accent=null, profile={}, intensity=100) => {
    ...
    if (window.UniversalVoiceHumanization && accent) {
      return window.UniversalVoiceHumanization.humanizeAccentText(text, accent, profile, { influence:adjustedIntensity });
    }
  ...
  window.UniversalAccentPhonemeMath = { STYLE, styleFromAccent, applyTextColor, cadenceFromAccent };
})();
