...
/* Universal Voice Studio - math-applied fantasy biome accents. Real-world source labels stay out of the UI. */
(() => {
  'use strict';
  ...
  window.UniversalBiomeAccents = { BIOMES, APPLIED_BIOMES, RACE_OVERLAYS, CLASS_OVERLAYS, listOptions, resolveBiomeKey, getBiome, classifyRace, classifyClass, inferFromText, applyAccent, describeAccent, cadenceFromVector };
})();
