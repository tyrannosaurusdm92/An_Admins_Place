...
const useChatStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        fetchConversations: async ()=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/chats');
                set({
        ...
        fetchMessages: async (chatId)=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/chats/${chatId}/messages`);
                set((state)=>({
                        messages: {
                            ...state.messages,
        ...
        sendMessage: async (content)=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/chats/${activeConversationId}/messages`, {
                    content
                });
        ...
        createConversation: async ()=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/chats');
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        login: async (credentials)=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', credentials);
        ...
        register: async (userData)=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register', userData);
                const { access_token, user } = response.data;
                localStorage.setItem('token', access_token);
                set({
                    user,
        ...
        fetchMe: async ()=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/users/profile');
                set({
                    user: response.data,
                    isAuthenticated: true
                });
        ...
        updateProfile: async (updates)=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch('/users/profile', updates);
                set({
                    user: response.data,
                    isLoading: false
                });
...
function ChatWidget() {
    ...
    if ($[0] !== "40c431bad2a4664f0088b512ac0c5993d5682ceb2faaf50248d09602debb3112") {
        for(let $i = 0; $i < 41; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "40c431bad2a4664f0088b512ac0c5993d5682ceb2faaf50248d09602debb3112";
    }
    ...
    const { conversations, activeConversationId, sendMessage, addConversation, isTyping } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useChatStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatStore"])();
    const currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])(_ChatWidgetUseAuthStore);
    let t0;
...
_s(ChatWidget, "vSw+gINVBMPYXH1OrCOotomFVuo=", false, function() {
    return [
...
function _ChatWidgetUseAuthStore(state) {
    return state.user;
}
var _c;
...
function Sidebar(t0) {
    ...
    if ($[0] !== "1609715681eddbc234d09349aa9c46ce4c087261a8737656b4d4513da0675012") {
        for(let $i = 0; $i < 33; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1609715681eddbc234d09349aa9c46ce4c087261a8737656b4d4513da0675012";
    }
    ...
    let t4;
    if ($[7] !== t3) {
        t4 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("fixed inset-y-0 left-0 w-72 bg-card border-r border-border/40 p-6 flex flex-col z-50 transition-transform duration-500 ease-in-out lg:translate-x-0 shadow-[10px_0_30px_-15px_rgba(0,0,0,0.05)]", t3);
        $[7] = t3;
        $[8] = t4;
    } else {
        t4 = $[8];
...
function Topbar(t0) {
    ...
    if ($[0] !== "aa6ea54d4ff990bb612bc9d59dac10a24b6e56defa764787a96f23d9879e4428") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "aa6ea54d4ff990bb612bc9d59dac10a24b6e56defa764787a96f23d9879e4428";
    }
...
function DashboardLayout(t0) {
    ...
    if ($[0] !== "2f0b5625efd9cc800b7e8efb766191c8e53576ea7053b2ae7a9615d839949f31") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2f0b5625efd9cc800b7e8efb766191c8e53576ea7053b2ae7a9615d839949f31";
    }
    const { children } = t0;
    ...
    const { fetchMe, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    let t1;
    let t2;
    if ($[1] !== fetchMe || $[2] !== isAuthenticated) {
        t1 = ({
    ...
    let t5;
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex flex-col min-h-screen w-full transition-all duration-300", "lg:pl-72");
        $[8] = t5;
    } else {
        t5 = $[8];
    }
...
_s(DashboardLayout, "43s1Yr8mHok8i0kihGv4LY77msw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuthStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"]
    ];
});
...
//# sourceMappingURL=src_8b822996._.js.map