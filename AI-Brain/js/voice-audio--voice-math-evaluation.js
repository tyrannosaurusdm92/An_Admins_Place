...
/* Universal Voice Studio - lightweight evaluation metrics for voice previews/reference recordings */
(() => {
  'use strict';
  ...
  window.UniversalEvaluationMath = { mcd, rmse, cosine, snr, summarizeFit };
})();
