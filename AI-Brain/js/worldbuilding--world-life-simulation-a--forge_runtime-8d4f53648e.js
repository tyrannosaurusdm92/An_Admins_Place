...
(function (global) {
  ...
  var TECHNOLOGY = ['Stone Age','Bronze Age','Iron Age','Medieval','Industrial','Electrical','Modern','Near-Future','Spacefaring'];
  ...
  function modesFor(tech, interconnectedness) {
    var modes = [['footpath','coastal canoe'],['caravan','riverboat'],['caravan','sailing ship'],['caravan','canal barge','sailing ship'],['rail','steamship','ferry','airship'],['electrified rail','steamship','submarine','airship'],['high-speed rail','airline','submarine','ferry'],['maglev','orbital aircraft','autonomous ship','submersible'],['planetary transit','orbital shuttle','starship','portal']][tech] || ['rail'];
  ...
  function populationBand(tech, area, rng) {
    var base = [120000,450000,950000,1800000,9500000,24000000,78000000,140000000,260000000][tech] || 1000000;
  ...
  function generate() {
    ...
    var tech = Number(q('technology-level') && q('technology-level').value || 4);
