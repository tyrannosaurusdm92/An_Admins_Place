...
/* Universal Voice Studio - helper functions for the full Voice Generator JSON Pack */
(() => {
  'use strict';
  const Pack = () => window.UNIVERSAL_VOICE_GENERATOR_PACK || null;
  ...
  const taxonomy = () => Pack()?.taxonomy || window.UNIVERSAL_VOICE_TAXONOMY || null;
  ...
  window.UniversalVoiceGeneratorPack = { taxonomy, counts, sourceFiles, normalize, resolveRace, resolveClass, resolveSubclass, resolveClassProfile, getRaceProfile, getClassProfile, toProfile, listRaces, listClasses, listSubclasses, inferFromText, bestMatchFromText, packSummary };
})();
