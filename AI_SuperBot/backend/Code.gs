 ...
 * Version 1.1.0-superbot-intelligence
 *
 * DEPLOYMENT:
...
var SuperbotThreeD = (function () {
  ...
  function fallbackSpec_(prompt, request) {
    ...
    return {
      ...
      buildNotes: ['Every piece remains separately selectable and editable.', 'Export as GLB, OBJ, STL, or JSON blueprint.', 'Send the generated GLB directly into the Effects Studio for surface editing.']
    };
  }
